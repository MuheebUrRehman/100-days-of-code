...
for (var index = 0; guests.length > 2; index++) {
    var removed = guests.pop();
    console.log("".concat(removed, " sorry i cant invite you"));
}
guests.forEach(function (guests) { return console.log("".concat(guests, " you are still invited")); });
guests.pop();
guests.pop();
console.log(guests);
